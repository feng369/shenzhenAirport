 ...
 */
@Table("logistics_sendgoods")
public class logistics_sendgoods extends BaseModel implements Serializable {
    ...
    @Comment("合同编号")
    @ColDefine(type = ColType.VARCHAR,width=100)
    private String contractcode;//2

    @Column
    @Comment("件号")
    @ColDefine(type = ColType.VARCHAR, width = 100)
    private String partnum;//3

    @Column
    @Comment("序号")
    @ColDefine(type = ColType.VARCHAR,width = 100)
    private String serialnum;//4
    ...
    @Comment("架位")
    @ColDefine(type = ColType.VARCHAR,width = 32)
    private String shelf;//6

    @Column
    @Comment("批次号")
    @ColDefine(type = ColType.VARCHAR,width = 100)
    private String batchnum;//7
    ...
    private Sys_dict transport;//9*

    @Column
    @Comment("毛重")
    @ColDefine(type = ColType.VARCHAR,width = 32)
    private String rough;//10
    ...
    private base_warehouse warehouse;//11
    ...
    @Comment("收货方")
    @ColDefine(type = ColType.VARCHAR,width = 500)
    private String receivename;//15

    @Column
    @Comment("收货地址")
    @ColDefine(type = ColType.VARCHAR,width = 500)
    private String receiveaddress;//16

    @Column
    @Comment("联系电话")
    @ColDefine(type = ColType.VARCHAR,width = 32)
    private String tel;//17

    @Column
    @Comment("发货日期")
    @ColDefine(type = ColType.VARCHAR,width = 32)
    private String senddate;//18
    ...
    @One(field = "sender")
    private base_person person;//19

    @Column
    @Comment("运单号")
    @ColDefine(type = ColType.VARCHAR,width = 100)
    private String billnum;//20
    ...
    @One(field = "packID")
    private logistics_unplan pack;//21
    ...
    public String getSendnum() { return sendnum; }

    public void setSendnum(String sendnum){ this.sendnum=sendnum;}
    ...
    //("状态(1创建需求-2发料完成-3核料-4包装-5计划-6审批-7发货中-8交货-9完成)")
    public String getStausType(){
        switch (pstatus){
            case 1:return  "创建需求";
            case 2:return "发料完成";
            case 3:return "核料";
